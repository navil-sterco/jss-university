...
const Edit = ({ faculty, types: initialTypes, schools }) => {
    ...
    const submit = (e) => {
        e.preventDefault();
        post(route("faculty.update", faculty.id));
    };
                            ...
                            <div className="card-body">
                                <div className="row">
                                    ...
                                    <div className="mb-3 col-12">
                                        ...
                                        <div className="form-text text-danger">{errors.teaching}</div>
                                    </div>
                                    ...
                                    <div className="mb-3 col-12">
                                        ...
                                        <div className="form-text text-danger">{errors.award}</div>
                                    </div>
                                    ...
                                    <div className="mb-3 col-12">
                                        ...
                                        <div className="form-text text-danger">{errors.social_engagement}</div>
                                    </div>
                                ...
                                <div className="mt-4">
                                    <button
                                        ...
                                        disabled={processing}
                                    >
                                        {processing ? "Updating..." : "Update Faculty/Staff"}
                                    </button>
