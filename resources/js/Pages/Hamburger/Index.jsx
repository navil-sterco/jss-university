...
const Index = () => {
    ...
    const handleConfirmDelete = () => {
        if (idDelete) {
            get(route('hamburger.destroy', idDelete), {
                preserveScroll: true,
                onSuccess: () => {
    ...
    const saveMenuOrder = () => {
        ...
        router.post(route('hamburger.update-order'), {
            items: itemsToSave
        }, {
            preserveScroll: true,
            onSuccess: () => {
    ...
    const toggleStatus = (id) => {
        router.post(route('hamburger.toggle-status', id), {}, {
            preserveScroll: true,
            onSuccess: () => {
                ...
                <div className="card-body">
                    <div className="d-flex flex-column flex-lg-row justify-content-between align-items-start gap-3">
                        ...
                        <div className="d-flex flex-wrap gap-2 w-100 w-lg-auto justify-content-start justify-content-lg-end">
                            ...
                            <Link
                                href={route('hamburger.edit', item.id)}
        ...
        <>
            ...
            <div className="d-flex justify-content-between align-items-center mb-4">
                ...
                <div className="d-flex gap-2">
                    ...
                    <Link href={route('hamburger.create')} className="btn btn-primary">
                ...
                <div className="card-body p-2 p-md-3">
                    {items.length === 0 ? (
                        <div className="text-center py-5">
                            ...
                            <Link href={route('hamburger.create')} className="btn btn-primary btn-sm">
